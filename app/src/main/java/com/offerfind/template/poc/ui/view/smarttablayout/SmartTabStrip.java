...
class SmartTabStrip extends LinearLayout {
  ...
  private void drawDecoration(Canvas canvas) {
    ...
    if (tabCount > 0) {
      ...
      int selectedStart = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getStart(selectedTab, indicatorWithoutPadding);
      int selectedEnd = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getEnd(selectedTab, indicatorWithoutPadding);
      int left;
      int right;
      if (isLayoutRtl) {
        left = selectedEnd;
      ...
      if (selectionOffset > 0f && selectedPosition < (getChildCount() - 1)) {
        ...
        int nextStart = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getStart(nextTab, indicatorWithoutPadding);
        int nextEnd = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getEnd(nextTab, indicatorWithoutPadding);
        if (isLayoutRtl) {
  ...
  private void drawSeparator(Canvas canvas, int height, int tabCount) {
    ...
    for (int i = 0; i < tabCount - 1; i++) {
      ...
      int end = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getEnd(child);
      int endMargin = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginEnd(child);
