 ...
 */
package com.offerfind.template.poc.ui.view.smarttablayout;
...
import com.offerfind.template.poc.ui.view.smarttablayout.*;
import com.offerfind.template.poc.ui.view.smarttablayout.Utils;
...
public class SmartTabLayout extends HorizontalScrollView {
    ...
    protected final com.offerfind.template.poc.ui.view.smarttablayout.SmartTabStrip tabStrip;
    ...
    public SmartTabLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.tabStrip = new com.offerfind.template.poc.ui.view.smarttablayout.SmartTabStrip(context, attrs);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (tabStrip.isIndicatorAlwaysInCenter() && tabStrip.getChildCount() > 0) {
            ...
            int start = (w - com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMeasuredWidth(firstTab)) / 2 - com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginStart(firstTab);
            int end = (w - com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMeasuredWidth(lastTab)) / 2 - com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginEnd(lastTab);
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            final View tabView = (tabProvider == null)
                    ? createDefaultTabView(adapter.getDrawableId(i))
    ...
    private void scrollToTab(int tabIndex, float positionOffset) {
        ...
        final boolean isLayoutRtl = com.offerfind.template.poc.ui.view.smarttablayout.Utils.isLayoutRtl(this);
        View selectedTab = tabStrip.getChildAt(tabIndex);
        int widthPlusMargin = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getWidth(selectedTab) + com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginHorizontally(selectedTab);
        ...
        if (tabStrip.isIndicatorAlwaysInCenter()) {
            ...
            if (0f < positionOffset && positionOffset < 1f) {
                ...
                int selectHalfWidth = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getWidth(selectedTab) / 2 + com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginEnd(selectedTab);
                int nextHalfWidth = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getWidth(nextTab) / 2 + com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginStart(nextTab);
            ...
            int x;
            if (isLayoutRtl) {
                int first = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getWidth(firstTab) + com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginEnd(firstTab);
                int selected = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getWidth(selectedTab) + com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginEnd(selectedTab);
                x = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getEnd(selectedTab) - com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginEnd(selectedTab) - extraOffset;
                x -= (first - selected) / 2;
            } else {
                int first = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getWidth(firstTab) + com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginStart(firstTab);
                int selected = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getWidth(selectedTab) + com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginStart(selectedTab);
                x = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getStart(selectedTab) - com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginStart(selectedTab) + extraOffset;
                x -= (first - selected) / 2;
            }
        ...
        if (titleOffset == TITLE_OFFSET_AUTO_CENTER) {
            ...
            if (isLayoutRtl) {
                x = -com.offerfind.template.poc.ui.view.smarttablayout.Utils.getWidthWithMargin(selectedTab) / 2 + getWidth() / 2;
                x -= com.offerfind.template.poc.ui.view.smarttablayout.Utils.getPaddingStart(this);
            } else {
                x = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getWidthWithMargin(selectedTab) / 2 - getWidth() / 2;
                x += com.offerfind.template.poc.ui.view.smarttablayout.Utils.getPaddingStart(this);
            }
        ...
        int start = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getStart(selectedTab);
        int startMargin = com.offerfind.template.poc.ui.view.smarttablayout.Utils.getMarginStart(selectedTab);
        if (isLayoutRtl) {
            x += start + startMargin - extraOffset - getWidth() + com.offerfind.template.poc.ui.view.smarttablayout.Utils.getPaddingHorizontally(this);
        } else {
