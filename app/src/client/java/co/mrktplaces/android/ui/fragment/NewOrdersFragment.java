...
import co.mrktplaces.android.core.api.strongloop.OpportunityPostRepository;
...
import co.mrktplaces.android.ui.adapter.ViewPagerAdapter;
...
public class NewOrdersFragment extends BaseLocationFragment implements View.OnClickListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private void createNewOrders(String address, Location addressLocation) {
        ...
        co.mrktplaces.android.core.api.strongloop.Location location = new co.mrktplaces.android.core.api.strongloop.Location();
